...
```{thumbnail} figures-for-doc/pangolin-predictor-stack.png
:width: 100%
```
...
```{thumbnail} figures-for-doc/progressive_construction.png
:width: 100%
```
...
```{thumbnail} figures-for-doc/boyce_curves.png
:width: 55%
```
...
```{thumbnail} figures-for-doc/posterior_individual_slopes_ndvi.png
:width: 75%
```
...
```{thumbnail} figures-for-doc/rsf_surface_lions.png
:width: 75%
```
...
```{thumbnail} figures-for-doc/river_proximity_coefficients.png
:width: 100%
```
...
![Baseline movement kernel](figures-for-doc//vultures/combined_movement_kernels.png)
